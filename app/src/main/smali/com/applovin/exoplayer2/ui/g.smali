...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    :cond_1
    sget v3, Lcom/applovin/sdk/R$layout;->exo_player_view:I
    ...
    sget-object v9, Lcom/applovin/sdk/R$styleable;->PlayerView:[I
    ...
    :try_start_0
    sget v9, Lcom/applovin/sdk/R$styleable;->PlayerView_shutter_background_color:I

    invoke-virtual {v8, v9}, Landroid/content/res/TypedArray;->hasValue(I)Z

    move-result v9

    sget v10, Lcom/applovin/sdk/R$styleable;->PlayerView_shutter_background_color:I

    invoke-virtual {v8, v10, v5}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v10

    sget v11, Lcom/applovin/sdk/R$styleable;->PlayerView_player_layout_id:I

    invoke-virtual {v8, v11, v3}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v3

    sget v11, Lcom/applovin/sdk/R$styleable;->PlayerView_use_artwork:I

    invoke-virtual {v8, v11, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v11

    sget v12, Lcom/applovin/sdk/R$styleable;->PlayerView_default_artwork:I

    invoke-virtual {v8, v12, v5}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v12

    sget v13, Lcom/applovin/sdk/R$styleable;->PlayerView_use_controller:I

    invoke-virtual {v8, v13, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v13

    sget v14, Lcom/applovin/sdk/R$styleable;->PlayerView_surface_type:I

    invoke-virtual {v8, v14, v7}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v14

    sget v15, Lcom/applovin/sdk/R$styleable;->PlayerView_resize_mode:I

    invoke-virtual {v8, v15, v5}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v15

    sget v4, Lcom/applovin/sdk/R$styleable;->PlayerView_show_timeout:I

    invoke-virtual {v8, v4, v6}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v6

    sget v4, Lcom/applovin/sdk/R$styleable;->PlayerView_hide_on_touch:I

    invoke-virtual {v8, v4, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v4

    sget v5, Lcom/applovin/sdk/R$styleable;->PlayerView_auto_show:I

    invoke-virtual {v8, v5, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v5

    sget v7, Lcom/applovin/sdk/R$styleable;->PlayerView_show_buffering:I
    ...
    sget v3, Lcom/applovin/sdk/R$styleable;->PlayerView_keep_content_on_player_reset:I
    ...
    sget v3, Lcom/applovin/sdk/R$styleable;->PlayerView_hide_during_ads:I
    ...
    sget v3, Lcom/applovin/sdk/R$id;->exo_content_frame:I
    ...
    :cond_3
    sget v3, Lcom/applovin/sdk/R$id;->exo_shutter:I
    ...
    sget v3, Lcom/applovin/sdk/R$id;->exo_ad_overlay:I
    ...
    sget v3, Lcom/applovin/sdk/R$id;->exo_overlay:I
    ...
    sget v3, Lcom/applovin/sdk/R$id;->exo_artwork:I
    ...
    :cond_a
    sget v3, Lcom/applovin/sdk/R$id;->exo_subtitles:I
    ...
    :cond_b
    sget v3, Lcom/applovin/sdk/R$id;->exo_buffering:I
    ...
    sget v3, Lcom/applovin/sdk/R$id;->exo_error_message:I
    ...
    :cond_d
    sget v3, Lcom/applovin/sdk/R$id;->exo_controller:I
    ...
    sget v7, Lcom/applovin/sdk/R$id;->exo_controller_placeholder:I
    ...
    sget v0, Lcom/applovin/sdk/R$id;->exo_controller:I
...
.method private static a(Landroid/content/res/Resources;Landroid/widget/ImageView;)V
    ...
    sget v0, Lcom/applovin/sdk/R$drawable;->exo_edit_mode_logo:I
    ...
    sget v0, Lcom/applovin/sdk/R$color;->exo_edit_mode_background_color:I
...
.method private m()V
    ...
    sget v1, Lcom/applovin/sdk/R$string;->exo_controls_hide:I
    ...
    sget v1, Lcom/applovin/sdk/R$string;->exo_controls_show:I
